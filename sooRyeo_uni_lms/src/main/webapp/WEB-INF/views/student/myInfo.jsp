	      ...
	      <div class="card-body">
			...
			<form action="#" name="studentFrm" method="post" enctype="multipart/form-data" class="profile-form">
				...
				<div class="card-footer d-flex">
				    <div class="mr-auto">
				    <c:if test="${requestScope.member_student.status != 4 && requestScope.member_student.status != 3 && requestScope.member_student.status != 1 && requestScope.application_status != 1}">
				    ...
				    <c:if test="${requestScope.member_student.status != 4 && requestScope.member_student.status != 3 && requestScope.member_student.status != 2 && requestScope.application_status != 2}">
				    ...
				    <c:if test="${requestScope.member_student.status != 4 && requestScope.member_student.status != 3 && requestScope.application_status != 3}">
