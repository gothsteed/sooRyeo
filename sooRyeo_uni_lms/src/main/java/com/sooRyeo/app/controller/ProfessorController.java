...
public class ProfessorController {
	...
	public ModelAndView professor_info_edit(MultipartHttpServletRequest mrequest, ModelAndView mav, Professor professor) {// 교수 정보 수정
		     
	      int n = service.professor_info_edit(mrequest, professor);
